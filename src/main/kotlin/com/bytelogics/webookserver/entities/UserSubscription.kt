...
@Document
data class UserSubscription(@Id val id: String = UUID.randomUUID().toString(),
                            val userId: String /*Booker will be loaded on return to client*/,
                              //val bookingEntityId: String /*BookingEntity will be loaded on return to client*/,
                            @DBRef val entity: UserEntity,
